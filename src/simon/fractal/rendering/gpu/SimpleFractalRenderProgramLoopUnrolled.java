...
public class SimpleFractalRenderProgramLoopUnrolled implements FractalRenderProgram{
	
	private static final Logger logger = LoggerFactory.create(SimpleFractalRenderProgramLoopUnrolled.class);
	...
	public SimpleFractalRenderProgramLoopUnrolled() throws CLException, FractalBuildException{
